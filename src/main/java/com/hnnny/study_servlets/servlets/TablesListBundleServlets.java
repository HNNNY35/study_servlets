...
@WebServlet(urlPatterns = "/tablesListBundleServlets")
public class TablesListBundleServlets extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        printwiter.println("<div class='fs-3'>Tables Normal</div>");
